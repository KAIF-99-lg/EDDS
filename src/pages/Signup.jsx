      ...
      <div className="flex-1 flex items-center justify-center p-4 py-8">
        ...
        <div className="w-full flex overflow-hidden rounded-2xl shadow-2xl" style={{ maxWidth: 1100, height: "85vh", minHeight: 580 }}>
          ...
          <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center px-8 sm:px-12 py-8 overflow-y-auto">
            ...
            <p className="text-slate-500 text-sm mb-5">Join ZenMD Healthcare Platform</p>
            ...
            {/* Google */}
            <button className="w-full flex items-center justify-center gap-3 border border-slate-200 bg-white hover:bg-slate-50 hover:border-blue-300 rounded-xl py-2.5 text-sm font-medium text-slate-700 transition-all duration-200 shadow-sm mb-4">
              <GoogleIcon />
          ...
          <div className="hidden lg:block w-1/2 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 z-10">
              ...
              <h2 className="text-white text-xl font-bold mb-2">Join ZenMD Today</h2>
